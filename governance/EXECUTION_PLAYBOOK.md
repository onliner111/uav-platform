...
- Excludes: phase definitions and phase acceptance content (owned by `phases/phase-*.md`) and product milestone strategy (owned by `governance/ROADMAP.md`).

# governance/EXECUTION_PLAYBOOK.md — 一网统飞（单体 Monolith + 插件式 Adapter + 多租户）零预装依赖版
